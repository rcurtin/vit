class Actions(object):
    ...
    def register(self):
        ...
        self.action_registrar.register('TASK_LIST_CYCLE', 'Cycle list: today/tomorrow/short-term/long-term')
        self.action_registrar.register('TASK_ESTIMATE', 'Set a time estimate for a task')
